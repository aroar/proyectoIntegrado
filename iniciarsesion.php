...
<body>
    ...
    <div class="container text-white" id="contenedorsesion">
        ...
        <form class="form-horizontal" name="form-inicio" role="form" method="post" action="iniciarsesion.php">
            <div class="form-group">
                <h4 for="exampleInputEmail1">Nombre de usuario</h4>

                <input type="text" name="username" id="username" tabindex="1" class="form-control" value="">
            </div>
            <div class="form-group">
                <h4 for="exampleInputEmail1">Contraseña</h4>
        ...
        if (isset($_POST['iniciarsesion'])) {
            ...
            if ($dato > 0) {
                ...
                if ($dato['Admin'] == 1) {
                    ...
                    header('Refresh: 1 , url=cartelera.php');
                }
            } else {
                // elimino las sesiones y muestro mensaje de error
                $_SESSION['email'] = null;
